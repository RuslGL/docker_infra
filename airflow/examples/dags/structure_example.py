...
dag = DAG(
    'ruslan_gl_first_dag',  # Уникальное имя DAG
...
task_extract = PythonOperator(
    ...
    op_args=['http://www.cbr.ru/scripts/XML_daily.asp', '01/06/2024', './extracted_data.xml'],
...
task_upload = PythonOperator(
    ...
    op_args=['./transformed_data.csv', 'ruslan_gl_first_dag', CH_CLIENT],
    dag=dag,
)
